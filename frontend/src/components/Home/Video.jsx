          ...
          <div className="right pl-24 xl:pl-2 col-start-3 col-span-2 xl:col-start-4 text-white py-4">
            ...
            <p className="relative text-xs grid gap-4 max-w-xs font-semibold">
              ...
              <span className="relative z-10">
                "This platform has completely transformed how I approach healthy
                eating. The recipes are not only nutritious but also incredibly
                delicious. I've never felt more energetic and satisfied."
          ...
          <div className="left row-start-5 text-white py-4">
            ...
            <div className="relative w-fit border-t-2 space-y-3 mt-4 border-white">
              <p className="leading-tight text-xs max-w-[15rem] pt-4">
                Explore a world of flavor and health with our curated recipes.
                Whether you're a beginner or a seasoned chef, our easy-to-follow
                guides will inspire your culinary journey.
              </p>
